...
int main(int argc, char** argv) {
	...
	//load tree from file
	octomap::OcTree* tree = new octomap::OcTree("../../octomap/octomap-1.6.1/octomap/share/data/geb079.bt");
...
//	}
	...
	octomap::point3d start(-3.0,0.0,0.0);
	octomap::point3d end(30.0,-0.01,0.0);
