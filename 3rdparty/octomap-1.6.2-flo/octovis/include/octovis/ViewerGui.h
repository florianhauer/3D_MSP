...
namespace octomap {
  ...
  private:
    ...
    void addOctree(AbstractOcTree* tree, int id, pose6d origin,std::deque<octomap::point3d> ppath,std::deque<std::pair<octomap::point3d,double> > fpath,octomap::point3d start,octomap::point3d end,std::deque<std::pair<octomap::point3d,double> > obstacles);
    void addOctree(AbstractOcTree* tree, int id);
    void addOctree(octomap::AbstractOcTree* tree, int id,std::deque<octomap::point3d> ppath,std::deque<std::pair<octomap::point3d,double> > fpath,octomap::point3d start,octomap::point3d end,std::deque<std::pair<octomap::point3d,double> > obstacles);
